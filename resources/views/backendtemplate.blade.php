  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item {{ Request::is('salary*') ? 'active' : '' }}" href="{{route('salary.index')}}"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Salary</span></a></li>

        <li><a class="app-menu__item {{ Request::is('location*') ? 'active' : '' }}" href="{{route('location.index')}}"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Location</span></a></li>
      </ul>
    </aside>
